...
export function App() {
  const { initialize, refreshHardware, handleStream, activeId, conversations, messages, error, isGenerating, generationState, toolActivities, toolActivityCount, analysisProgress, analysisRuns, editMessage, continueGeneration, lastFinishReason } = useAppStore();
